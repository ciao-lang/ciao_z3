...
:- trust pred z3_get_version(go(A),go(B),go(C),go(D)) :: c_uint * c_uint * c_uint * c_uint + foreign('Z3_get_version').
...
:- trust pred z3_finalize_memory + foreign('Z3_finalize_memory').
...
:- trust pred z3_solver_check_(in(Ctx), in(Solver), go(LBool)) :: 
...
:- trust pred z3_solver_check_assumptions1_(in(Ctx), in(Solver), in(Assumption), go(LBool)) :: 
	address * address * address * c_int + (foreign('solver_check_assumptions1'), returns(LBool)).

:- export(z3_model_eval/6).
:- trust pred z3_model_eval(in(Ctx), in(Model), in(X), in(ModelComplete), go(V), go(Success)) :: 
...
:- trust pred z3_mk_int_symbol(in(Ctx), in(Int), go(Symbol)) ::
	address * c_int * address + (foreign('Z3_mk_int_symbol'), returns(Symbol)).
:- trust pred z3_mk_string_symbol(in(Ctx), in(String), go(Symbol)) ::
...
:- trust pred z3_mk_const(in(Ctx), in(Symbol), in(Sort), go(T)) ::
...
:- trust pred z3_mk_real_sort(in(Ctx), go(Sort)) ::
	address * address + (foreign('Z3_mk_real_sort'), returns(Sort)).
:- trust pred z3_mk_int_sort(in(Ctx), go(Sort)) ::
	address * address + (foreign('Z3_mk_int_sort'), returns(Sort)).
:- trust pred z3_mk_bool_sort(in(Ctx), go(Sort)) ::
	address * address + (foreign('Z3_mk_bool_sort'), returns(Sort)).
:- trust pred z3_mk_array_sort(in(Ctx), in(Domain), in(Range), go(Sort)) ::
...
%:- export(z3_mk_and2/4).
:- trust pred z3_mk_and2(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('mk_and2')).
%:- export(z3_mk_or2/4).
:- trust pred z3_mk_or2(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('mk_or2')).
%:- export(z3_mk_false/2).
:- trust pred z3_mk_false(in(Ctx), go(R)) :: address * address + (returns(R), foreign('Z3_mk_false')).
%:- export(z3_mk_true/2).
:- trust pred z3_mk_true(in(Ctx), go(R)) :: address * address + (returns(R), foreign('Z3_mk_true')).
%:- export(z3_mk_implies/4).
:- trust pred z3_mk_implies(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_implies')).
%:- export(z3_mk_not/3).
:- trust pred z3_mk_not(in(Ctx), in(X), go(R)) :: address * address * address + (returns(R), foreign('Z3_mk_not')).
%:- export(z3_mk_eq/4).
:- trust pred z3_mk_eq(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_eq')).
%:- export(z3_mk_lt/4).
:- trust pred z3_mk_lt(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_lt')).
%:- export(z3_mk_gt/4).
:- trust pred z3_mk_gt(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_gt')).
%:- export(z3_mk_le/4).
:- trust pred z3_mk_le(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_le')).
%:- export(z3_mk_ge/4).
:- trust pred z3_mk_ge(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_ge')).
%:- export(z3_mk_store/5).
:- trust pred z3_mk_store(in(Ctx), in(A), in(I), in(V), go(R)) :: address * address * address * address * address + (returns(R), foreign('Z3_mk_store')).
%:- export(z3_mk_select/4).
:- trust pred z3_mk_select(in(Ctx), in(A), in(I), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_select')).
%:- export(z3_mk_mul/4).
:- trust pred z3_mk_mul(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('mk_mul2')).
%:- export(z3_mk_add/4).
:- trust pred z3_mk_add(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('mk_add2')).
%:- export(z3_mk_sub/4).
:- trust pred z3_mk_sub(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('mk_sub2')).
%:- export(z3_mk_unary_minus/3).
:- trust pred z3_mk_unary_minus(in(Ctx), in(X), go(R)) :: address * address * address + (returns(R), foreign('Z3_mk_unary_minus')).
%:- export(z3_mk_xor/4).
:- trust pred z3_mk_xor(in(Ctx), in(X), in(Y), go(R)) :: address * address * address * address + (returns(R), foreign('Z3_mk_xor')).
%:- export(z3_mk_numeral/4).
:- trust pred z3_mk_numeral(in(Ctx), in(S), in(Ty), go(R)) :: address * string * address * address + (returns(R), foreign('Z3_mk_numeral')).
...
:- trust pred z3_term_to_string(in(Ctx), in(Term), go(String)) ::
...
:- trust pred z3_get_numeral_int_(in(Ctx), in(Term), go(V), go(Success)) ::
...
:- trust pred z3_get_numeral_int64_(in(Ctx), in(Term), go(V), go(Success)) ::
...
:- trust pred z3_get_numeral_uint64_(in(Ctx), in(Term), go(V), go(Success)) ::
	address * address * c_uint * c_int + (foreign('Z3_get_numeral_uint64'), returns(Success)).

:- export(z3_get_error_msg_ex/3).
:- trust pred z3_get_error_msg_ex(in(Ctx), in(ErrorCode), go(String)) ::
...
:- trust pred z3_solver_get_model(in(Ctx), in(Solver), go(Model)) ::
...
:- trust pred smt2clp(in(In), in(Out)) :: atm * atm + foreign.
